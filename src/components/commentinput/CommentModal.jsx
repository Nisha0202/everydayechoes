  ...
  return (
    <div className="fixed inset-0 z-50 overflow-auto bg-smoke-light flex m-2">
      <div className="relative p-8 bg-gray-100 dark:bg-gray-700 w-full max-w-md m-auto flex-col flex rounded-md">
        ...
        <h1 className="text-sm font-light mb-4">Comment on {blogData.title}</h1>
        ...
        <button
          ...
          className="bg-blue-600 font-medium text-white mt-4 px-4 py-2 rounded text-sm"
        >
          {/* <IoSend className='text-center text-lg w-full'/> */} Post
        </button>
      </div>
    </div>
  );
